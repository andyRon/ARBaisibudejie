...
static ARTopicNewM *lastTopicM_;
...
@implementation ARLookingAroundV
...
-(void) layoutSubviews{
    ...
    //ARLog(@"--- %@ --- ",NSStringFromCGRect(progressV_.frame));
}
...
- (void)timer{
    ...
    if (currentTime > 0){
        ...
        //ARLog(@" --- progress %f --- ",progressV_.progress)
    }
}
