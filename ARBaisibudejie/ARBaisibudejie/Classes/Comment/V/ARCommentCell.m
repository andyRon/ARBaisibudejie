...
#import "ARCommentCell.h"
#import "ARUserM.h"
#import "ARCommentM.h"
#import <AVFoundation/AVFoundation.h>
#import <MediaPlayer/MediaPlayer.h>

@interface ARCommentCell ()
...
-(void)setComment:(ARCommentM *)comment{
    _comment = comment;
    ...
    if (comment.user.total_cmt_like_count >= 1000) {
        ...
        self.totalLikeCountLbl.backgroundColor = comment.user.total_cmt_like_count >= 10000 ? ARColor(250, 195, 198) : ARColor(212, 205, 214);
    } else {
