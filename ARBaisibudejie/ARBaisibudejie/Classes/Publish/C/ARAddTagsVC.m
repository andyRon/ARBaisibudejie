...
- (void)setupTextField{
    ARTagTextField *textField = [[ARTagTextField alloc] init];
...
- (void)addBtnClick{
    ...
    ARTagBtn *tagBtn = [ARTagBtn buttonWithType:UIButtonTypeCustom];
...
- (void)tagBtnClick:(ARTagBtn *)tagBtn{
...
- (BOOL)textFieldShouldReturn:(ARTagTextField *)textField{
