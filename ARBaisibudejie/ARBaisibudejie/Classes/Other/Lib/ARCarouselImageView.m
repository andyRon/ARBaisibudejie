...
@interface ARCarouselImageView () <UIScrollViewDelegate>

@property (nonatomic, weak) id<ARCarouselImageViewDelegate>     delegate;
@property (nonatomic, copy) DidTapCarouselImageViewAtIndexBlock block;
@property (nonatomic, strong) ARCarouselImageManager           *imageManager;
...
@implementation ARCarouselImageView

#pragma mark - Lazy
- (ARCarouselImageManager *)imageManager {
    if (!_imageManager) {
        __weak typeof(self) weakSelf = self;
        _imageManager = [[ARCarouselImageManager alloc] init];
